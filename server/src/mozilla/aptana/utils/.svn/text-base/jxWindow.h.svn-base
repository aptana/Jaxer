...
#ifndef __APT_WINDOW_H__
#define __APT_WINDOW_H__
...
class jxWindow :	public jxIWindow,
...
public:
	...
	NS_DECL_CYCLE_COLLECTION_CLASS_AMBIGUOUS(jxWindow, jxIWindow)

private:
	~jxWindow();

	nsresult CreateDocShell();
	void InitScriptContext();
	nsresult RequestCompleted();
	nsresult LocationChanged(nsIRequest *aRequest);
	...
	friend class jxWindowBadCertHandler;
...
protected:
	...
	nsCOMPtr<jxILocationChangeListener> mOnLocationChangeListener;
	nsCOMPtr<nsIScriptContext> mScriptContext;
	PRInt32	mState;
    PRPackedBool               mRedirect;

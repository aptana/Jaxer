...
#include "xptcstubsdef.inc"
    ...
    nsXPTCStubBase(nsIXPTCProxy* aOuter, const nsIID& aIID, nsIInterfaceInfo* aInterfaceInfo) :
        mOuter(aOuter), mEntry(aInterfaceInfo), mIID(aIID) { }
#else

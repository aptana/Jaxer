...
{
	// *************************************************************************
	private	String 	HTMLUNIT_TEST_NAME = "html/aptanadownload";	// <-- used in URL; specific to THIS test
	// *************************************************************************
	...
	protected void setUp() throws Exception 
	{
    	...
    	String sURL = new String("http://" + HTMLUNIT_SERVER_NAME + ":" + HTMLUNIT_SERVER_PORT + "/test/test.msi");
    ...
    private class WorkerThread extends TestRunnable 
    {
        ...
        public void runTest() throws Throwable 
        {
			...
			{
				doRandomSleep();
			    Page result = webClient.getPage(url);

                System.out.println("Page type = " + result.getClass());

				// No DOM validation necessary since we are just doing aptana download stress tests
			}
        }
    }

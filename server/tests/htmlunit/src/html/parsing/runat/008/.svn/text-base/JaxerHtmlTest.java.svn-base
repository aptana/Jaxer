...
{
	// *************************************************************************
	private	String 	HTMLUNIT_TEST_NAME = "html/parsing/runat/008";	// <-- used in URL; specific to THIS test
	// *************************************************************************
...
if (b) {
				...
				// Make sure the <script> that had its content evaporated is NOT present in the document
				HtmlElement element = null;
				try {
					element = page.getHtmlElementById("script1");
				}
				catch (Exception e)	{}
			    assertNull( element);
				...
				// Make sure the <script> element's contents are now empty.  It
				// originally contained only functions that were marked as "@runat server"
				// and these should have been sucked out of the client-side
				// HTML stream.

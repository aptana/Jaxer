...
{
	// *************************************************************************
	private	String 	HTMLUNIT_TEST_NAME = "html/parsing/runat/003";	// <-- used in URL; specific to THIS test
	// *************************************************************************
    ...
    private class WorkerThread extends TestRunnable 
    {
        ...
        public void runTest() throws Throwable 
        {
			...
			for (int i=0; i < JaxerHtmlTestUtil.getRequestCount(); i++)
			{
				...
				// Make sure the <script> with runat=client tag is present in the document
				HtmlElement element = page.getHtmlElementById("s");

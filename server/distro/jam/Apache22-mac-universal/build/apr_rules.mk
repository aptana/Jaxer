...
#
apr_builddir=/Applications/Aptana_Jaxer/Apache22/build
apr_builders=/Applications/Aptana_Jaxer/Apache22/build
...
LINK         = $(LIBTOOL) $(LTFLAGS) --mode=link $(LT_LDFLAGS) $(COMPILE) -version-info 2:11:2 $(ALL_LDFLAGS) -o $@

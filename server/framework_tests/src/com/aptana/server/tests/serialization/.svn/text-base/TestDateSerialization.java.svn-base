 ...
 */
public class TestDateSerialization extends AbstractTest
{
	/**
	...
	{
		return super.getBaseURLString() + "html-junit/serialization/date/";
	}
	...
	{
		assertEquals("\"2007-07-17T11:57:30\"", this.getOutput("serializeDate.html"));
	}
}

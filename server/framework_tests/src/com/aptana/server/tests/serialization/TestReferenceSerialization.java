 ...
 */
public class TestReferenceSerialization extends AbstractTest
{
	/**
	...
	{
		return super.getBaseURLString() + "html-junit/serialization/references/";
	}
	...
	public void testSerializeString() throws Exception
	{
		assertEquals(
			...
			"]",
			this.getOutput("serializeReferences.html")
		);
	}
}

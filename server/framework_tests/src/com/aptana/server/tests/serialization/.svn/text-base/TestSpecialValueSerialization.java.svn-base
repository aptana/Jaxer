 ...
 */
public class TestSpecialValueSerialization extends AbstractTest
{
	/**
	...
	{
		return super.getBaseURLString() + "html-junit/serialization/special/";
	}
	...
	{
		assertEquals("null", this.getOutput("serializeNull.html"));
	}
	...
	{
		assertEquals("null", this.getOutput("serializeUndefined.html"));
	}
}

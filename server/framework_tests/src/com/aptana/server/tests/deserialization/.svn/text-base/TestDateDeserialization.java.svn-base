 ...
 */
public class TestDateDeserialization extends AbstractTest
{
	/**
	...
	{
		return super.getBaseURLString() + "html-junit/deserialization/date/";
	}
	...
	{
		assertEquals("Tue, 17 Jul 2007 13:04:35 GMT", this.getOutput("deserializeDate.html"));
	}
}

 ...
 */
public class TestSpecialValueDeserialization extends AbstractTest
{
	/**
	...
	{
		return super.getBaseURLString() + "html-junit/deserialization/special/";
	}
	...
	/**
	 * testDeserializeSpecialValue
	 * 
	 * @throws Exception
	 */
	public void testDeserializeSpecialValue() throws Exception
	{
		assertEquals("null", this.getOutput("deserializeSpecialValue.html"));
	}
}

 ...
 */
public class TestStringDeserialization extends AbstractTest
{
	/**
	...
	{
		return super.getBaseURLString() + "html-junit/deserialization/string/";
	}
	...
	{
		assertEquals("hello", this.getOutput("deserializeString.html"));
	}
}

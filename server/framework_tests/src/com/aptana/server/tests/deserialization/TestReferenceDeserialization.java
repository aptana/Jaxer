 ...
 */
public class TestReferenceDeserialization extends AbstractTest
{
	/**
	...
	{
		return super.getBaseURLString() + "html-junit/deserialization/references/";
	}
	...
	/**
	 * testDeserializeReferences
	 * 
	 * @throws Exception
	 */
	public void testDeserializeReferences() throws Exception
	{
		assertEquals("[object Object]", this.getOutput("deserializeReferences.html"));
	}
}

 ...
 */
public class TestBothAndCacheAttribute extends AbstractDatabaseTest
{
	/**
	 * ClientAttributeTest
	 */
	public TestBothAndCacheAttribute()
	{
	}
	...
	{
		return super.getBaseURLString() + "html-junit/runat/bothCacheAttribute/";
	}

	/**
	 * testBothAndCacheAttribute
	 * 
	 * @throws Exception
	 */
	public void testBothAndCacheAttribute() throws Exception
	{
		// get script elements
		URL url = this.getURL("bothCacheAttribute.html");

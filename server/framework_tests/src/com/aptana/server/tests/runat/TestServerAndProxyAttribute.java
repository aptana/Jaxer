 ...
 */
public class TestServerAndProxyAttribute extends AbstractDatabaseTest
{
	/**
	 * ClientAttributeTest
	 */
	public TestServerAndProxyAttribute()
	{
	}
	...
	{
		return super.getBaseURLString() + "html-junit/runat/serverProxyAttribute/";
	}

	/**
	 * testServerAndProxyAttribute
	 * 
	 * @throws Exception
	 */
	public void testServerAndProxyAttribute() throws Exception
	{
		// get script elements
		URL url = this.getURL("serverProxyAttribute.html");
